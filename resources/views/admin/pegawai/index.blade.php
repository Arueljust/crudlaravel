...
<div class="card card-info">
    <div class="card-header">
        <div class="d-flex justify-content-between">
            <h5 class="text-bold">Pegawai</h5>
            <a href="{{ route('pegawai.create') }}" class="btn btn-sm btn-light text-dark text-bold">Tambah Data
                +</a>
        </div>
    </div>
    <!-- /.card-header -->
    <div class="card-body">
                ...
                @foreach ($data as $item)
                    <tr>
                        ...
                        <td class="text-center">
                            <a class="btn btn-outline-success" href="{{ route('pegawai.show', $item->id) }}"><svg
                        ...
                        <td class="text-center">
                            <a class="btn btn-outline-primary" href="{{ route('pegawai.edit', $item->id) }}"><svg
                                    xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
        ...
        <div>
            <h5 class="text-center text-bold text-warning">Jumlah Pegawai : {{ $data->count() }}</h5>
        </div>
    </div>
    <!-- /.card-body -->
</div>
